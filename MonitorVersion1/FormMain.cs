...
namespace MonitorVersion1
{
    public partial class FormMain : Form
    {
        ...
        private void FormMain_Load(object sender, EventArgs e)
        {
            ...
            //Thread tc3 = new Thread(() => { checkTC3(); });
            //Thread ace = new Thread(() => { checkAcecook(); });
            //Thread hl = new Thread(() => { checkHL(); });
            //tc3.Start();
            //ace.Start();
            //hl.Start();
        ...
        private void Timer3_Tick(object sender, EventArgs e)
        {
            ...
            if (DateTime.Now.Minute % 5 != 0)
            {
                ...
                if ((listNoti.Count - currentNoti) > 0)
                {
        ...
        int currentNoti; //Khởi tạo (-1) để fix lỗi hiển thị lần đầu tiên, khi chưa click notify
        ...
        private void getNotify()
        {
            ...
            //Acecook
            txbNotyfiyShow(isCheckedAcecook1, "Acecook HY - G1", listNoti);
            txbNotyfiyShow(isCheckedAcecook2, "Acecook HY - G2", listNoti);
            txbNotyfiyShow(isCheckedAcecook3, "Acecook HY - G3", listNoti);
